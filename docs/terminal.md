...
If you already have duplicates use the [tips here](/docs/fix_zsh_path_duplicates.md) to remove them correctly.
...
I have created many useful aliases over the years. Sometimes to save time on commands I run all the time, sometimes for a more involved set of instructions that I can't remember when I need them. My current aliases are located [here](https://github.com/rikosintie/Ubuntu4NetworkEngineers/blob/main/docs/my-aliases.md).
